...
#*Random Forest Classifier Coding. For small dataset images this works good. It sometimes works better than SVM.
#* This is some sort of collection of decision trees. For understanding decisin tree watch the video.
