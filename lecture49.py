...
#*This is a good example for classification problem. 
#*all the columns may not carry importance, so that column should be dropped to improve the accuracy. 
import pandas as pd
from matplotlib import pyplot as plt

#STEP 1: DATA READING AND UNDERSTANDING

df = pd.read_csv("CSVFiles/images_analyzed_productivity1.csv")
print(df.head())
