...
#*How to create Gabor feature banks for machine learning
#*The goal of this lecture is to end up with a pandas dataframe that has various gabor responses from an input image. 
#*After creating gabor bank it can be used in random forest algorithm. 
