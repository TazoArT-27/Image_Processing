...
#!!!!!!!!!!!!!!!!!!!!!!!!!!!! FEATURE EXTRACTION !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
#!!!!!!!!!!!!!!!!!!!!!!!!!!!! This filter is so useful as feature extractor !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
#*for more info go through lecture61.py 
...
#todo theta can be called the main thing. If this is 45 degree the train image will show only the things of 45 degrees. 
lamda = 1*np.pi /5  #1/4 works best for angled. 
gamma=0.4  #Value of 1 defines spherical. Value close to 0 has high aspect ratio
